...
urlpatterns = [
  ...
  path('waitforvalidation/', views.waitforvalidation, name='waitforvalidation'),
  # path('employeeprofile/', views.display_employee_profile, name='employee_profile'),

  path('logout/', views.user_logout, name='logout'),
  path('jobs/<int:employer_id>', views.displayJobsEmployer, name='jobs'),
  path('jobs/<int:employer_id>/profile/', views.display_employer_profile, name='employer_profile'),
  path('profile/edit/<int:employer_id>/', views.edit_employer_profile, name='edit_employer_profile'),
  ...
  path('profile/<int:applicant>/', views.display_employee_profile, name='employee_profile'),
  path('profile/<int:applicant>/edit/', views.edit_employee_profile, name='edit_employee_profile'),
